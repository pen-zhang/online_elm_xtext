 ...
 * <!-- end-user-doc -->
 * @see org.xtext.online_elm.onlineElm.OnlineElmPackage#getBOOL_OP()
 * @model
 * @generated
 */
public enum BOOL_OP implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final BOOL_OP[] VALUES_ARRAY =
    new BOOL_OP[]
    {
      AND,
      OR,
   ...
   * @generated
   */
  public static final List<BOOL_OP> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
   ...
   * @generated
   */
  public static BOOL_OP get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      BOOL_OP result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static BOOL_OP getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      BOOL_OP result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  public static BOOL_OP get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private BOOL_OP(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
